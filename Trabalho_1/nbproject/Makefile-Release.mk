...
${OBJECTDIR}/Q4/1menuBubble.o: nbproject/Makefile-${CND_CONF}.mk Q4/1menuBubble.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Q4/1menuBubble.o Q4/1menuBubble.c

${OBJECTDIR}/Q4/2menuInsertion.o: nbproject/Makefile-${CND_CONF}.mk Q4/2menuInsertion.c 
	${MKDIR} -p ${OBJECTDIR}/Q4
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Q4/2menuInsertion.o Q4/2menuInsertion.c

${OBJECTDIR}/Q4/3menuMerge.o: nbproject/Makefile-${CND_CONF}.mk Q4/3menuMerge.c 
	${MKDIR} -p ${OBJECTDIR}/Q4
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Q4/3menuMerge.o Q4/3menuMerge.c

${OBJECTDIR}/Q4/4menuQuick.o: nbproject/Makefile-${CND_CONF}.mk Q4/4menuQuick.c 
	${MKDIR} -p ${OBJECTDIR}/Q4
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Q4/4menuQuick.o Q4/4menuQuick.c

${OBJECTDIR}/Q4/5menuHeap.o: nbproject/Makefile-${CND_CONF}.mk Q4/5menuHeap.c 
	${MKDIR} -p ${OBJECTDIR}/Q4
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Q4/5menuHeap.o Q4/5menuHeap.c

${OBJECTDIR}/Q4/questao4.o: nbproject/Makefile-${CND_CONF}.mk Q4/questao4.c 
	${MKDIR} -p ${OBJECTDIR}/Q4
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Q4/questao4.o Q4/questao4.c
...
${OBJECTDIR}/questao1.o: nbproject/Makefile-${CND_CONF}.mk questao1.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/questao1.o questao1.c

${OBJECTDIR}/questao2.o: nbproject/Makefile-${CND_CONF}.mk questao2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/questao2.o questao2.c

${OBJECTDIR}/questao3.o: nbproject/Makefile-${CND_CONF}.mk questao3.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/questao3.o questao3.c

${OBJECTDIR}/questao5.o: nbproject/Makefile-${CND_CONF}.mk questao5.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/questao5.o questao5.c
